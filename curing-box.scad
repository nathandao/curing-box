...
top_rim_height = 10;
top_rim_outer_bottom_diameter = outer_diameter;
top_rim_inner_bottom_diameter = top_rim_outer_bottom_diameter - (wall_thickness / 2);
top_rim_outer_top_diameter = outer_diameter + 3;
top_rim_inner_top_diameter = top_rim_outer_top_diameter - (wall_thickness / 2);

bottom_rim_height = top_rim_height;
bottom_rim_outer_top_diameter = outer_diameter;
bottom_rim_inner_diameter = bottom_rim_outer_top_diameter - wall_thickness;
bottom_rim_outer_bottom_diameter = outer_diameter + 10;
...
module body() {
     difference () {
          union() {
               translate([0, 0, 10])
                    main_cylinder_with_inner_groove();
...
module main_cylinder() {
     difference() {
          cylinder(h = height,
                   d = outer_diameter);
          cylinder(h = height,
                   d = inner_diameter - thread_height);
     }
}


module main_cylinder_with_inner_groove() {
     difference() {
          main_cylinder();
          metric_thread(diameter = inner_diameter,
                        thread_size = 1,
                        groove = 1,
                        rectangle = 1,
                        pitch = 9,
...
module top_rim() {
     difference() {
          cylinder(h = top_rim_height,
                   d1 = top_rim_outer_bottom_diameter,
                   d2 = top_rim_outer_top_diameter);
          cylinder(h = top_rim_height,
                   d1 = top_rim_inner_bottom_diameter,
                   d2 = top_rim_outer_bottom_diameter);
     }
}

module bottom_rim() {
     difference() {
          cylinder(h = bottom_rim_height,
                   d1 = bottom_rim_outer_bottom_diameter,
                   d2 = bottom_rim_outer_top_diameter);
          cylinder(h = bottom_rim_height,
                   d = bottom_rim_inner_diameter);
     }
}
